...
Dynamic sequence generation that increases difficulty each round

Visual and audio cues for intuitive gameplay

Responsive button interaction with animations

Game-over detection with restart functionality

💡 How It Works

The game highlights a random colored button along with a corresponding sound.
